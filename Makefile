...
build_readme: README.ipynb
	PYTHONPATH=src poetry run jupyter nbconvert --to markdown --execute README.ipynb && rm -rf docs/README_files/ && mv README_files docs/ && pandoc --from=markdown --to=rst --output=README README.md
